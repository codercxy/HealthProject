...
public class SearchResultDetailActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        switch (id) {
            case 0:
                text1 = "偏头痛（migraine）是临床最常见的原发性头痛类型，临床以发作性中重度、搏动样头痛为主要表现，头痛多为偏侧，一般持续4～72小时，可伴有恶心、呕吐，光、声刺激或日常活动均可加重头痛，安静环境、休息可缓解头痛。偏头痛是一种常见的慢性神经血管性疾患，多起病于儿童和青春期，中青年期达发病高峰，女性多见，男女患者比例约为1∶2～3，人群中患病率为5%～10%，常有遗传背景。\n";
                text2 = "遗传因素\n\n" +
            ...
            case 1:
                text1 = "脑肿瘤";
                text2 = "长期接触铀、镭等放射性物质及其衍化物、致癌性碳氢化合物、砷、铬、镍、铜、锡、铁、煤焦油、沥青、石油、石棉、芥子气等物质，均可诱发脑肿瘤";
                text3 = "增强体质，多在阳光下运动，多出汗可将体内酸性物质随汗液排出体外，避免形成酸性体质";
                break;
            case 2:
                text1 = "脑膜炎";
                text2 = "";

...
import com.nju.android.health.providers.DbHelper;
...
public class Search_View extends LinearLayout {
    ...
    /*初始化搜索框*/
    private void init(){
        Log.e("search_view", context.toString());
...
//                            getCurrentFocus().getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);
                    ...
                    turnToResult(et_search.getText().toString());
...
//        insertData("Leo" + time);
    ...
    private void turnToResult(String keyword) {
    ...
    private void initView(){
        ...
        tv_clear = (TextView) findViewById(R.id.search_clear);
        tv_tip = (TextView) findViewById(R.id.search_history);

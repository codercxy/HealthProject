...
public class SaveDaymonitorActivity extends AppCompatActivity {
    ...
    private ImageView datetimepickerbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pres_save_daymonitor);
        pretime = (TextView)findViewById(R.id.pretime);
        prehigh = (EditText)findViewById(R.id.prehigh);
        prehigh.setInputType(EditorInfo.TYPE_CLASS_PHONE);
        prehigh.setInputType(EditorInfo.TYPE_CLASS_PHONE);

        prelow = (EditText)findViewById(R.id.prelow);
        ...
        datetimepickerbtn = (ImageView)findViewById(R.id.datetimepicker);
        ...
        datetimepickerbtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(SaveDaymonitorActivity.this);
        ...
        savebtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SaveDaymonitorActivity.this,AnlsActivity.class);
